 ...
 <div class="sidebar sidebar-style-2" data-background-color="dark">
        ...
        <div class="sidebar-content">
          <ul class="nav nav-secondary">
            ...
            <li class="nav-item <?php echo (basename($_SERVER['PHP_SELF']) == 'opportunities.php') ? 'active' : ''; ?>">
                  ...
                  <ul class="dropdown-menu dropdown-user animated fadeIn">
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li class="dropdown-item">
                        <a href="http://localhost/smarthr/applicant/settings.php" class="text-black">Settings</a>
                    </li>
                    <div class="dropdown-divider"></div>
                    <li class="dropdown-item">
                        <a href="http://localhost/smarthr/logout.php" class="text-black">Logout</a>
                    </li>
                    </div>
                  </ul>
                </li>
